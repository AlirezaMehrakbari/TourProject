...
import "@/app/components/superAdmin/calender.css"
...
const SuperAdmin = () => {
    const all = [
        ...
        },
        {
            ...
            logo: <svg xmlns="http://www.w3.org/2000/svg" width="31" height="32" viewBox="0 0 31 32" fill="none">
                <path d="M0.957031 30.4482H29.014" stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round"
                ...
                <path
                    d="M2.66406 26.6433C3.17922 23.7087 4.62825 21.4054 6.90273 19.4809C9.1772 17.5563 12.0545 16.4901 15.0338 16.4678C18.0072 16.4747 20.8813 17.5376 23.1438 19.4668C25.4063 21.3961 26.9099 24.0662 27.3865 27.0011"
                    stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round" strokeLinejoin="round"/>
                <path
                    ...
                    stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M15.0352 3.8291V7.37211" stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round"
                      strokeLinejoin="round"/>
                <path d="M7.66016 7.55566V11.0029" stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round"
                      strokeLinejoin="round"/>
                <path d="M22.4062 6.22363V9.67091" stroke="#FF7512" strokeWidth="1.91515" strokeLinecap="round"
                      strokeLinejoin="round"/>
            </svg>,
        ...
        },
        {
            ...
            logo: <svg xmlns="http://www.w3.org/2000/svg" width="29" height="25" viewBox="0 0 29 25" fill="none">
                ...
                <path
                    d="M23.2307 23.6482V20.7921C23.2307 19.2772 22.6452 17.8243 21.6029 16.7531C20.5606 15.6819 19.147 15.0801 17.673 15.0801H6.55768C5.08369 15.0801 3.67007 15.6819 2.62781 16.7531C1.58554 17.8243 1 19.2772 1 20.7921V23.6482"
                    stroke="#FF7512" strokeWidth="2.00077" strokeLinecap="round" strokeLinejoin="round"/>
                <path
                    ...
                    fill="#FF7512" stroke="#FF7512" strokeWidth="2.00077" strokeLinecap="round"
                    strokeLinejoin="round"/>
                <path
                    ...
                    fill="#FF7512" stroke="#F0F0F0" strokeWidth="0.764182" strokeLinecap="round"
                    strokeLinejoin="round"/>
                <path
                    d="M28.0921 21.61V18.754C28.0912 17.4883 27.6813 16.2589 26.9269 15.2586C26.1724 14.2584 25.1161 13.5439 23.9238 13.2275"
                    stroke="#FF7512" strokeWidth="1.22269" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>,
            title: 'بازه سنی'
        }
    ]
    ...
    const [valuees, setValues] = useState<Value>(new Date());
    ...
    const handleAddTour = ( ) => {
        ...
        tripTourApi.post('tours/store', {
            title : "title" , tourManager : "khosh"
        },{
            headers : {
                Authorization : `Bearer 2|cuO4L3MPv36gYWTIrSXKo86PJN0Hr8UndCu0EN6lc997a2b9`
            }
        }).then(res=> {
            router.push(`/superadmin/tourregistration/${res.data.data.id}`)
        }).catch(error=>{
            ...
            <div
                ...
                <div
                    ...
                    <form
                        ...
                        <Logo width={'w-[90%]'}/>
                        <h2 className='text-[21px] font-kalameh500 pt-10'>افزودن تور جدید</h2>
                        <div
                            className={`px-2 bg-[#EDECEC] py-3 rounded-[5px] mt-4 w-full `}>
                            <input
                                className={`bg-transparent outline-0`}
                                type='text'
                                placeholder='نام تور را واردکنید '
                                value={title}
                                            ...
                                            <div className='w-full flex flex-wrap gap-x-4 gap-y-7 justify-center'>
                                                {
                                                    all.map((item) => (
                                                        ...
                                                        // </div>
                                                        <div className='w-[400px] flex flex-col bg-[#F0F0F0] rounded-2xl px-4 py-4 gap-y-2'>
                                                            <div>
                                                                {item.logo}
                                                            </div>
                                                            <div>
                                                                <input placeholder={item.title} className='w-full bg-[#F0F0F0] p-3 focus:outline-none'/>
                                                            </div>
