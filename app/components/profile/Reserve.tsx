...
const Reserve = () => {
    const detail = [
        {
            id: 1,
            logo: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none">
        ...
        {
            id: 1,
            logo: <svg xmlns="http://www.w3.org/2000/svg" width="27" height="23" viewBox="0 0 27 23" fill="none">
        ...
        {
            id: 1,
            logo: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23" fill="none">
    ...
    return (
        ...
        <div className='flex flex-col w-[100%] mt-[15px] px-1 md:flex-row'>
            <div className='w-[350px] mx-auto flex flex-row flex-wrap md:flex-col'>
                ...
                {/* <div className='flex ml-[150px] w-[80%] md:pt-[8.51px] justify-end'>
                ...
                <div className='px-[14.31px]'>
                    <p className='py-[2px] text-[9.50px] text-[#777]'>تاریخ سفر</p>
                    <p className='text-[13.50px] text-[#000] font-kalameh500'>5 ابان ماه</p>
                </div>
            </div> */}
                ...
                <div className='px-[14.31px]'>
                    <p className='py-[2px] text-[9.50px] text-[#777]'>تعداد مسافران</p>
                    <p className='text-[13.50px] text-[#000] font-kalameh500'>3نفر </p>
                </div>
            </div> */}
                {/* <div className='flex mt-[23px]'>
                <div className='pt-[10px]'>
                ...
                <div className='px-[14.31px]'>
                    <p className='py-[2px] text-[9.50px] text-[#777]'> اطلاعات کاربر</p>
                    <p className='text-[13.50px] text-[#000] font-kalameh500'>امیر محمدی</p>
                </div>
            </div>
            <div className='flex mt-[23px]'>
                <div className='pt-[10px]'>
                ...
                <div className='px-[14.31px]'>
                    <p className='py-[2px] text-[9.50px] text-[#777]'>هزینه اقامت هر شب </p>
                    <p className='text-[13.50px] text-[#000] font-kalameh500'>300,000تومان</p>
                </div>
            </div>
            <div className='flex mt-[23px]'>
                <div className='pt-[10px]'>
                ...
                <div className='px-[14.31px]'>
                    <p className='py-[2px] text-[9.50px] text-[#777]'> مدت اقامت</p>
                    <p className='text-[13.50px] text-[#000] font-kalameh500'>2 شب </p>
                </div>
            </div> */}
            </div>
            ...
            <div className='w-[90%] flex px-[10%]'>
                ...
                <div className='flex flex-col '>
                    <p className='mx-[40px] py-2 font-kalameh400 text-[12px]  text-[#000]'>ویلای دوخوابه</p>
                    <p className='mx-[40px] py-2 font-kalameh400 text-[9.2px] text-[#777676]'> گیلان ,آستارا</p>
                </div>
            </div>
            ...
            <div className=' w-[700px] flex px-[120px]'>
                ...
                <div className='flex flex-col px-3'>
                    <p className='px-[150px] font-kalameh500 text-[9px] py-2'>600,000 تومان</p>
                    <p className='px-[150px] font-kalameh500 text-[9px] '>600,000 تومان</p>
                </div>
            </div>
        </div>
        </div>
