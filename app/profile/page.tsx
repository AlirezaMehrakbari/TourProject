...
const ProfilePage = () => {
    ...
    return (
        <div className='w-[90%] flex flex-col'>
            ...
            <div className="w-full flex flex-col justify-evenly pb-10 pt-7 md:flex-row gap-x-8">
                <Sidebar />
                   <div>
                       <h1 className="font-kalameh700 pb-12 max-md:pt-10 max-md:text-center">حساب کاربری</h1>
                       <div className="w-full mx-auto flex flex-col rounded-md shadow-2xl bg-[#F8F8F8] py-8 md:mt-[-38px]">
